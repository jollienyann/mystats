...
class _IntroPageThree extends State<IntroPageThree> {
  List<ListObject> listObjects = [
    new ListObject("1","Meal","v1","2","0xe43b","0"),
    new ListObject("2","Sport","v2","2","0xe5e6","0"),
    new ListObject("3","Sleep","v3","1","0xe065","0"),
    new ListObject("4","Stress","v4","1","0xe6cc","0"),
    new ListObject("5","Mood","v5","1","0xe3fe","0"),
    new ListObject("6","Smoke","v6","2","0xe5c7","0"),
  ];
